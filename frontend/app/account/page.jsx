  ...
  return (
    <section className="section-pad">
      <div className="container-x">
        ...
        <div className="mt-8 flex items-center gap-4 rounded-3xl bg-white p-6 shadow-soft ring-1 ring-black/5">
          ...
          <div>
            ...
            <p className="text-sm capitalize text-ink-900/50">{user?.userRole} account</p>
          </div>
        </div>
                ...
                <div key={order._id} className="rounded-3xl bg-white p-6 shadow-soft ring-1 ring-black/5">
                  ...
                  <div className="mt-4 flex flex-wrap items-center justify-between gap-4 border-t border-dashed border-ink-900/10 pt-4">
                    <p className="text-sm text-ink-900/60">
                      Deliver to {order.address}, {order.city} · Paid ${order.payed}
                    </p>
